% ostserver(SECTION) | User Commands
%
% "January  5 2023"
...
ostserver - program to do something

# SYNOPSIS

**ostserver** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ostserver** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ostserver** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ostserver** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ostserver. See **foo.conf**(5) for further details.
...
**ostserver** provides some return codes, that can be used in scripts:
...
gilles <gilles@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 gilles
